...
class Surrogate:
    ...
    @overload
    def get_metric(self, mt: Metrics) -> numpy.ndarray[numpy.float64]: ...
    @overload
...
class Surrogate_Ensemble(Surrogate):
    ...
    @overload
    def model_list_add(self, arg0: dict[str, str | Models | WeightType | KernelType | DistanceType | Metrics | float | int]) -> None: ...
    @overload
...
class Surrogate_Parameters:
    ...
    @overload
    def __init__(self, arg0: dict[str, str | Models | WeightType | KernelType | DistanceType | Metrics | float | int]) -> None: ...
...
@overload
def Surrogate_Factory(arg0: TrainingSet, arg1: dict[str, str | Models | WeightType | KernelType | DistanceType | Metrics | float | int]) -> Surrogate: ...
@overload
def Surrogate_Factory(arg0: TrainingSet, arg1: Surrogate_Parameters) -> Surrogate: ...
def metric_type_to_norm_type(*args, **kwargs): ...
def metric_type_to_str(arg0) -> str: ...
def set_seed(seed: int) -> None: ...
def str_to_metric_type(*args, **kwargs): ...
